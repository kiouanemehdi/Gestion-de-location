...
<body>
	<header style="position: relative;">
        <div style="background-color: #e3fcf6; height: 100px;" class="px-3 py-2 text-white">
            <div class="container">
                ...
                <div style="position: absolute;" id="menu" class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    <!-- <div  class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
                        ...
                        <ul id="nav" class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                            ...
                            <li class="menu-hover">
                                <a href="voitures.php" class="nav-link " style="color: #2BD0AE;">
                                    <i style="color: #2BD0AE;" class="fas fa-car fa-3x"></i><br>
                                    <p style="font-weight: bold;">Voitures</p>
                                </a>
                            </li>
                            <li class="menu-hover">
                                 <a href="clients.php" class="nav-link " style="color: #2BD0AE;">
                                    <i style="color: #2BD0AE;" class="fas fa-user fa-3x"></i><br>
                                    <p style="font-weight: bold;">Clients</p>
                                </a>
                            </li>
                            <li class="menu-hover">
                                 <a href="documents.php" class="nav-link " style="color: #2BD0AE;">
                                    <i style="color: #2BD0AE;" class="fas fa-key fa-3x"></i><br>
                                   <p style="font-weight: bold;"> Locations</p>
                                </a>
                            </li>
                            <li class="menu-hover">
                                 <a href="reservations.php" class="nav-link " style="color: #2BD0AE;">
                                    <i style="color: #2BD0AE;" class="fas fa-undo fa-3x"></i><br>
